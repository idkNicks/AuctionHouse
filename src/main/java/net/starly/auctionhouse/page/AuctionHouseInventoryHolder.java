...
public record AuctionHouseInventoryHolder<T>(PaginationManager paginationManager, int nextButtonSlot, int prevButtonSlot, int warehouseButtonSlot) implements InventoryHolder {
